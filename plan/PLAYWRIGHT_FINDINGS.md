...
## 🔵 UX ПОКРАЩЕННЯ (від замовника)

### UX-1: QR-код занадто маленький
**Сторінка:** order_detail (SUBMITTED)
**Проблема:** QR 256x256px — маловато для сканування з екрану телефону.
**Фікс:** збільшити до 360x360px (+40%).

### UX-2: Статус оплати не відображається постійно
**Сторінки:** order_detail, waiter dashboard
**Проблема:** Стан оплати (оплачено/не оплачено) не видно відвідувачу і офіціанту після оформлення. Потрібно відображати постійно поруч зі статусом замовлення.

### UX-3: Кухня — інфо на кнопках замість окремих рядків
**Сторінка:** kitchen dashboard
**Проблема:** Кнопки "Взяти"/"Готово" великі, але інформація (офіціант, номер замовлення) окремо. Краще писати всю інфо прямо на кнопці.

### UX-4: Ім'я відвідувача в waiter dashboard
**Сторінка:** waiter dashboard, order cards
**Проблема:** Офіціант не бачить хто замовив. Персональне звернення збільшує довіру.

### UX-5: Location hint на waiter scan view
**Сторінка:** `/waiter/order/N/scan/`
**Проблема:** Офіціант не бачить "біля дерева" при скануванні QR. (= F-5)
